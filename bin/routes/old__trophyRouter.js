...
const genTrophies = (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    const data = JSON.parse(fs_1.default.readFileSync(TROPHY_DATA_FILE, 'UTF-8'));
 ...
 * @param res
 */
const insertScore = (req, res) => __awaiter(this, void 0, void 0, function* () {
    log.debug(__filename, req.url, 'Handling request -> ' + req.path);
    let score;
 ...
 * @param res
 */
const updateScore = (req, res) => __awaiter(this, void 0, void 0, function* () {
    log.debug(__filename, req.url, 'Handling request -> ' + req.path);
    let score = req.body;
    // instantiate as Score to validate document body
    try {
 ...
 * @param res - express.Response
 */
const deleteScore = (req, res) => __awaiter(this, void 0, void 0, function* () {
    log.debug(__filename, req.url, 'Handling request -> ' + req.path);
    const query = { id: req.params.scoreId };
    yield dbMan
...
//# sourceMappingURL=old__trophyRouter.js.map
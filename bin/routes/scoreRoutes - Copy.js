...
exports.scoreRouter = express_1.default.Router();
...
exports.scoreRouter.get('/service', getServiceDoc);
exports.scoreRouter.get('/countScores', (req, res) => {
    getCount(MONGO_COL_SCORES, req, res);
});
exports.scoreRouter.get('/countTrophies', (req, res) => {
    getCount(MONGO_COL_TROPHIES, req, res);
});
exports.scoreRouter.get('/getScores', (req, res) => {
    getDocs(MONGO_COL_SCORES, req, res);
});
exports.scoreRouter.get('/getTrophies', (req, res) => {
    getDocs(MONGO_COL_TROPHIES, req, res);
});
// special routes
exports.scoreRouter.get('/generate/default-trophy-list', genTrophies);
//app.get('/*', (req, res) => {
// Route -> http.put mappings
exports.scoreRouter.put('/insertScore', insertScore);
exports.scoreRouter.put('/updateScore', updateScore);
// Route -> http.delete mappings
exports.scoreRouter.delete('/deleteScore/:scoreId', deleteScore);
// capture all unhandled routes
exports.scoreRouter.get('/*', unhandledRoute);
exports.scoreRouter.put('/*', unhandledRoute);
exports.scoreRouter.delete('/*', unhandledRoute);
exports.scoreRouter.post('/*', unhandledRoute);
// expose router as module
exports.default = exports.scoreRouter;
//# sourceMappingURL=scoreRoutes - Copy.js.map
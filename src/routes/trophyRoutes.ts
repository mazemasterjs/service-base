...
export const trophyRouter = express.Router();
...
trophyRouter.get('/service', getServiceDoc);

trophyRouter.get('/countScores', (req, res) => {
  getCount(MONGO_COL_SCORES, req, res);
});
trophyRouter.get('/countTrophies', (req, res) => {
  getCount(MONGO_COL_TROPHIES, req, res);
});

trophyRouter.get('/getScores', (req, res) => {
  getDocs(MONGO_COL_SCORES, req, res);
});
trophyRouter.get('/getTrophies', (req, res) => {
  getDocs(MONGO_COL_TROPHIES, req, res);
});

// special routes
trophyRouter.get('/generate/default-trophy-list', genTrophies);

//app.get('/*', (req, res) => {

// Route -> http.put mappings
trophyRouter.put('/insertScore', insertScore);
trophyRouter.put('/updateScore', updateScore);

// Route -> http.delete mappings
trophyRouter.delete('/deleteScore/:scoreId', deleteScore);

// capture all unhandled routes
trophyRouter.get('/*', unhandledRoute);
trophyRouter.put('/*', unhandledRoute);
trophyRouter.delete('/*', unhandledRoute);
trophyRouter.post('/*', unhandledRoute);
